...
%%PROMPT P-023 "Conditional visibility"
...
%%PROMPT P-024 "Enhance value selection in Conditional Visibility part of Technical Design Schem"
...
%%PROMPT P-029 "Check 4"
Check what are the possible operators expected in the "visibleWhen" section of questions which are recognized by web application in `.rdd/src/web/static/app.js` and the conventions. I am interested only from the RDD, not the editor.
The results should be listed in report file (markdown format) in the prompt workdir
%%ENDPROMPT

%%PROMPT P-030 "OR logic in Conditional Visibility"
In implement OR logic via array values in `equals`
Read `.rdd-instance/workdir/P-029_Check 4/visibility-operators-report.md` for more details
%%ENDPROMPT

%%PROMPT P-031 "Saving Conditional Visibility is not working"
...
%%PROMPT P-036 "Create release prompts"
Read `.rdd-instance/workdir/P-034_Release automation/release_automation_analysis.md` and based on it create in the current prompt workdir a file release_prompts.md where:
- Write a series of prompts based on the analysis
- Prompts should be executed in sequence by GitHub Copilot agent
