...
RDD maintains a file with the requirements understood by the framework in `.rdd-instance/specifications/requirements.md`. 

## Tasks:

1. Review the provided requirements from [Product-Requirements-Specification-File] and `.rdd-instance/specifications/requirements.md` carefully.
...
4. Provide a full report of the differences and areas that may need clarification or further development in `.rdd-instance/workdir/compare-requirements.md`. Include sections for:
   - Missing Requirements in `.rdd-instance/specifications/requirements.md` document - generate new requirements to be added in the format used in `.rdd-instance/specifications/requirements.md`
   - Inconsistent Requirements between the two documents and sugestion which `.rdd-instance/specifications/requirements.md` to be updated (and how) to resolve them
   - Requirements in `.rdd-instance/specifications/requirements.md` which are invalid and should be removed or revised 