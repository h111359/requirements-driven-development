#!/usr/bin/env python3
"""
Set questionnaire-answered flag to true for a prompt.

Usage:
    python prompt_questionnaire_answered_on.py [prompt-id=<id>]
"""
...
def set_questionnaire_answered(prompt_id=None, value=True):
...
def main():
    ...
    exit_code = set_questionnaire_answered(prompt_id, True)
    sys.exit(exit_code)
