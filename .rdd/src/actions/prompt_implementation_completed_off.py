#!/usr/bin/env python3
"""
Set implementation-completed flag to false for a prompt.

Usage:
    python prompt_implementation_completed_off.py [prompt-id=<id>]
"""
...
def set_implementation_completed(prompt_id=None, value=False):
...
def main():
    ...
    exit_code = set_implementation_completed(prompt_id, False)
    sys.exit(exit_code)
