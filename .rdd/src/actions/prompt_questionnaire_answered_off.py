#!/usr/bin/env python3
"""
Set questionnaire-answered flag to false for a prompt.

Usage:
    python prompt_questionnaire_answered_off.py [prompt-id=<id>]
"""
...
def set_questionnaire_answered(prompt_id=None, value=False):
    ...
    target_prompt['questionnaire-answered'] = value
    ...
    print(f"SUCCESS: questionnaire-answered set to {value} for prompt '{prompt_id}'")
    return 0
...
def main():
    ...
    exit_code = set_questionnaire_answered(prompt_id, False)
    sys.exit(exit_code)
