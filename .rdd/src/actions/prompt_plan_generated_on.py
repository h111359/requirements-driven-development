#!/usr/bin/env python3
"""
Set plan-generated flag to true for a prompt.

Usage:
    python prompt_plan_generated_on.py [prompt-id=<id>]
"""
...
def set_plan_generated(prompt_id=None, value=True):
...
def main():
    ...
    exit_code = set_plan_generated(prompt_id, True)
    sys.exit(exit_code)
