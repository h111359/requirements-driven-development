#!/usr/bin/env python3
"""
Set analysis-generated flag to true for a prompt.

This script sets the analysis-generated flag to true for a specified prompt
in the work iteration registry. If no prompt-id is provided, it defaults
to the currently active prompt (one in 'active' state).

Usage:
    python prompt_analysis_generated_on.py [prompt-id=<id>]

Example:
    python prompt_analysis_generated_on.py prompt-id=P-003
    python prompt_analysis_generated_on.py  # Uses active prompt
"""
...
def set_analysis_generated(prompt_id=None, value=True):
    """
    Set analysis-generated flag for the specified prompt.
    ...
    # Set analysis-generated to the specified value
    target_prompt['analysis-generated'] = value
    ...
    print(f"SUCCESS: analysis-generated set to {value} for prompt '{prompt_id}'")
    return 0
...
def main():
    ...
    # Set analysis-generated flag
    exit_code = set_analysis_generated(prompt_id, True)
    sys.exit(exit_code)
