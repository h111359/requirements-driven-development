#!/usr/bin/env python3
"""
Set plan-generated flag to false for a prompt.

Usage:
    python prompt_plan_generated_off.py [prompt-id=<id>]
"""
...
def set_plan_generated(prompt_id=None, value=False):
    ...
    target_prompt['plan-generated'] = value
    ...
    print(f"SUCCESS: plan-generated set to {value} for prompt '{prompt_id}'")
    return 0
...
def main():
    ...
    exit_code = set_plan_generated(prompt_id, False)
    sys.exit(exit_code)
